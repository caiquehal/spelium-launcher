  ...
  return (
    <div className="h-full flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-6 left-0 w-full flex justify-center pointer-events-none z-[100]">
        <img src={speliumLogo} alt="Spelium" className="h-[175px] object-contain drop-shadow-gold-glow pointer-events-auto transition-transform hover:scale-105 duration-500" />
      </div>
